  ...
  return (
    <nav className="relative bg-gradient-to-r from-white via-blue-50 to-cyan-50 shadow-xl md:sticky md:top-0 z-50 backdrop-blur-sm border-b border-cyan-100">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* Desktop links */}
  <div className="hidden md:flex flex-row md:flex-row w-auto items-center space-x-6 mt-0 md:mt-0 overflow-y-visible whitespace-nowrap" ref={dropdownRef}>
          <Link href="/" legacyBehavior>
          ...
          >
            <button
              className="relative px-4 py-2 text-sm md:text-base text-gray-700 hover:text-cyan-600 transition-all font-medium group flex items-center focus:outline-none"
          ...
          <div
            className="dropdown relative w-auto"
            onMouseEnter={() => setOpenDropdown('products')}
            onMouseLeave={() => setOpenDropdown(null)}
          >
            <button
              className="relative px-4 py-2 text-sm md:text-base text-gray-700 hover:text-cyan-600 transition-all font-medium group w-auto text-center flex items-center justify-center focus:outline-none"
          ...
          <a href="#contact" className="relative inline-block px-4 py-2 text-sm md:text-base text-white bg-cyan-600 hover:bg-cyan-700 transition-all font-medium rounded-full shadow-md flex items-center w-auto justify-center">
